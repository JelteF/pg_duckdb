...
BuildDuckdbOnlyFunctions() {
	...
	/*
	 * We search the system cache for function with the given names. It's
	 * possible other functions with the same name are defined too though, so
	 * we need to check if each of the found functions is actually part of our extension.
	 */
